 ...
 * Hibernate: insert into ITEM (NAME, ITEM_ID) values (?, ?)
 * Hibernate: insert into BID (PRICE, ITEM_ID, BID_ID) values (?, ?, ?)
 * Hibernate: insert into BID (PRICE, ITEM_ID, BID_ID) values (?, ?, ?)
 * Hibernate: update BID set ITEM_ID=? where BID_ID=?
 * Hibernate: update BID set ITEM_ID=? where BID_ID=?
 *
 * With inverse no update queries
 * Hibernate: insert into ITEM (NAME, ITEM_ID) values (?, ?)
 * Hibernate: insert into BID (PRICE, ITEM_ID, BID_ID) values (?, ?, ?)
 * Hibernate: insert into BID (PRICE, ITEM_ID, BID_ID) values (?, ?, ?)
 */
public class ManyToOneOneToManyBidirectionalBidItemInverseItemWithInsertUpdateFalseTBC {
...
//                        .setProperty(Environment.HBM2DDL_AUTO, "update")
                        .addResource("ManyToOneOneToManyBidirectionalBidItemInverseItemWithInsertUpdateFalse.xml")
                        .buildSessionFactory();
