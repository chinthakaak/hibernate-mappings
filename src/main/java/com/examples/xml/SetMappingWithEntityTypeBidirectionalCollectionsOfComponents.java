...
//      Reverse direction - Incomplete
        ItemImage itemImage1 = (ItemImage) session.get(ItemImage.class, 1);
...
//                        .setProperty(Environment.HBM2DDL_AUTO, "update")
                        .addResource("SetMappingWithEntityTypeBidirectionalCollectionsOfComponents.xml")
                        .buildSessionFactory();
